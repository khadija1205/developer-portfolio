...
const EmailSection = () => {
    ...
    return (
        <section className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
            <div
                className="rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 transform -translate-x-1/2 -translate-1/2"
                style={{
                    background: 'radial-gradient(ellipse at center, rgb(88, 28, 135), transparent)'
                }}
            ></div>
            <div className='z-0'>
